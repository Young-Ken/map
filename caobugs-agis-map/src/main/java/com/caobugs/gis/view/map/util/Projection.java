package com.caobugs.gis.view.map.util;
...
//    }
     ...
     */
    public Coordinate GCJ02ToWGS84(Double gcj_lon,Double gcj_lat){
        if(outOfChina(gcj_lon, gcj_lat)){
            return new Coordinate(gcj_lon,gcj_lat);
        }
        ...
        return new Coordinate(gcj_lon * 2 - mglng, gcj_lat * 2 - mglat);
    }
