...
import com.snail.gis.shapefile.event.OnShapeStatusListener;
import com.snail.gis.shapefile.shp.exception.ShapeException;
import com.snail.gis.shapefile.shp.factory.CreateGeometry;
...
public class Analytical
{
    ...
    public void analyticalShape(RandomAccessFile accessFile, String shapeName) throws IOException
    {
       ...
       // channel.close();
        ...
        onShapeStatusListener.onStatusChanged(shapeName);
    }
