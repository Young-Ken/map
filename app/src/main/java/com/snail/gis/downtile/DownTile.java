package com.snail.gis.downtile;

import android.util.Log;

import com.snail.gis.downtile.httputil.TileDownloader;
...
public class DownTile
{
    ...
    {
        int minTileNumX = getTileNum(mapEnv.getMinX() + (-tileInfo.getOriginPoint().getX()), level );
        int minTileNumY = getTileNum(tileInfo.getOriginPoint().getY() - mapEnv.getMaxY(), level);
        int maxTileNumX = getTileNum(mapEnv.getMaxX() + (-tileInfo.getOriginPoint().getX()), level);
        int maxTileNumY = getTileNum(tileInfo.getOriginPoint().getY() - mapEnv.getMinY(), level);
