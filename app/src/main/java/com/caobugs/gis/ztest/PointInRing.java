...
import com.caobugs.gis.ztest.view.DrawView;
...
//            {
//
//                List<Point> list =  drawView.polygon.getExteriorRing().getPointArray();
//                Point[] cc = list.toArray(new Point[list.size()]);
//
//
//                //Point[] cc = (Point[]) drawView.polygon.getExteriorRing().getPointArray().toArray();
//
