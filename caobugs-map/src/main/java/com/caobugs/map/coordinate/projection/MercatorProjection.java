...
public final class MercatorProjection {
    ...
    public static Point getPixelWithScaleFactor(LatLong latLong, double scaleFactor, int tileSize) {
        double pixelX = MercatorProjection.longitudeToPixelXWithScaleFactor(latLong.getLongitude(), scaleFactor, tileSize);
        double pixelY = MercatorProjection.latitudeToPixelYWithScaleFactor(latLong.getLatitude(), scaleFactor, tileSize);
        return new Point((int) pixelX, (int) pixelY);
    }

    public static Point getPixel(LatLong latLong, long mapSize) {
        double pixelX = MercatorProjection.longitudeToPixelX(latLong.getLongitude(), mapSize);
        double pixelY = MercatorProjection.latitudeToPixelY(latLong.getLatitude(), mapSize);
        return new Point((int) pixelX, (int) pixelY);
    }
    ...
    public static Point getPixelRelative(LatLong latLong, long mapSize, double x, double y) {
        double pixelX = MercatorProjection.longitudeToPixelX(latLong.getLongitude(), mapSize) - x;
        double pixelY = MercatorProjection.latitudeToPixelY(latLong.getLatitude(), mapSize) - y;
        return new Point((int) pixelX, (int) pixelY);
    }
