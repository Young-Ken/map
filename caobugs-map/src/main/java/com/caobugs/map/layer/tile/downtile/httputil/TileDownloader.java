package com.caobugs.map.layer.tile.downtile.httputil;
        ...
        if (connection != null) {
            try {
                if ((connection.getResponseCode() == 404)) {
                    Log.e(TAG, connection.getResponseCode() + level + "  level " + col + "  col  " + row + "  row");
                    restult = false;
                    ...
                    Log.e(TAG, connection.getResponseCode() + " code " + level + "  level " + col + "  col  " + row + "  row");
                    Log.e(TAG, path + "");
                    restult = false;
                }

            } catch (Exception e) {
                Log.e(TAG, e.toString() + "  " + level + "  level " + col + "  col  " + row + "  row");
                Log.e(TAG, path + "");
                e.printStackTrace();
                restult = false;
            } finally {
